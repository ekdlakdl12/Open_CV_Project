...
| 4 | **이벤트 기반 자동 녹화** | 사고/위반 전후 시점의 영상을 증거 자료로 자동 저장. |
| 5 | **증거 메타데이터 관리** | 위반 차종, 시간, 속도, 번호판 정보를 DB에 정형화하여 기록. |
...
| **데이터베이스** | <img src="https://img.shields.io/badge/MySQL-4479A1?style=flat-square&logo=mysql&logoColor=white"/> | 차량 탐지 이력 및 법적 증거 데이터 관리 |
